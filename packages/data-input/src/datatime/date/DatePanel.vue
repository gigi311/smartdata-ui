...
<script type="text/babel">
  ...
  import TimePicker from '../daterange/TimePanel';
  import YearTable from '../basic/year-table';
  import MonthTable from '../basic/month-table';
  import DateTable from '../daterange/DateTable.vue';
  ...
  export default {
    ...
    methods: {
      ...
      handleTimePick(value, visible, first) {
        if (isDate(value)) {
          const newDate = this.value
            ? modifyTime(this.vDate, value.getHours(), value.getMinutes(), value.getSeconds())
            : modifyWithTimeString(this.getDefaultValue(), this.defaultTime);
          this.vDate = newDate;
          this.emit(this.vDate, true);
        } else {
      ...
      handleTimeInput(value){
        ...
        if (parsedValue) {
            this.vDate = modifyTime(this.vDate, parsedValue.getHours(), parsedValue.getMinutes(), parsedValue.getSeconds());
        }
      },
        ...
        if (this.selectionMode === 'day') {
          ...
          this.emit(value.date);
            ...
            if(value && value.length>0){
                ...
                this.vDate = this.value;
            }
            this.emit(value, true); // set false to keep panel open
          
            this.$emit('pick-click', this.vDate);
        }
      },
      ...
      handleDateInput(value) {
        ...
        if (parsedValue) {
            this.vDate = modifyDate(this.vDate || new Date(), parsedValue.getFullYear(), parsedValue.getMonth(), parsedValue.getDate());
            this.value = new Date(parsedValue);
        }
      },
    ...
    computed: {
      ...
      visibleTime() {
        if (this.userInputTime !== null) {
          ...
          return formatDate(this.vDate || this.defaultValue, this.timeFormat);
        }
      },
      ...
      visibleDate() {
        if (this.userInputDate !== null) {
          return this.userInputDate;
            ...
            if (this.vDate) return formatDate(this.vDate, this.dateFormat);
            return '';
