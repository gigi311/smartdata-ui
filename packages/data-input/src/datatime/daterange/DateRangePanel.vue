<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="el-picker-panel el-date-range-picker el-popper" style="width:auto;box-shadow: none"
      :class="[{
...
<script type="text/babel">
  ...
  import TimePicker from './TimePanel';
  ...
  export default {
    ...
    data() {
      return {
        ...
        showTime: this.showType.includes('time'),// 是否显示时间
        shortcuts: '',
        visible: true,
        disabledDate: '',
        cellClassName: '',
        ...
        format: '',
        arrowControl: false,
        unlinkPanels: false,// 默认联动，即显示两个看板时，一起翻页
        dateUserInput: {
          min: null,
          max: null
        },
    ...
    methods: {
      ...
      handleRangePick(val, close = true) {
        ...
        this.$emit('pick-click', [this.minDate, this.maxDate]);
    ...
    components:{DateTable, TimePicker},
  };
</script>
